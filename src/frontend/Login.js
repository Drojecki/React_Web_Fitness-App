...
const Login = () => {
  ...
  const handleLogin = async () => {
    try {
      const response = await fetch('https://react-web-fitness-app.onrender.com/api/auth/login', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        const protectedResponse = await fetch('https://react-web-fitness-app.onrender.com/api/protected', {
          method: 'GET',
          headers: {
